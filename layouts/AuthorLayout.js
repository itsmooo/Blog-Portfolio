        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8 xl:sticky xl:top-0">
            ...
            <div className="flex flex-col pt-3">
              <a
                className="rounded-full border px-8 py-2 text-center text-sm font-light text-gray-700 transition-colors hover:border-gray-800 hover:bg-gray-800 hover:text-white hover:shadow dark:text-white dark:hover:border-gray-200 dark:hover:bg-gray-200 dark:hover:text-gray-900"
                href="https://github.com/itsmooo"
                target="_blank"
          ...
          <div className="prose max-w-none pb-8 pt-8 dark:prose-dark xl:col-span-2">
            <p>
              ...
              >
                {text1} Currently, I work as a Software Engineer at{' '}
                <Link
                  href={'https://jtech.so/'}
            ...
            <p className="sm:block md:hidden lg:hidden">
              ...
              <span className="font-semibold">
                web development, mobile apps, AI, and machine learning
              </span>
              . I am always looking to learn new things and build products that solve real problems.
            </p>
            ...
            <p>
              ...
              <Link
                href={'mailto:maxamedadan169@gmail.com'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Mail
                <svg
              ...
              or{' '}
              <Link
                href={'https://api.whatsapp.com/send?phone=252617237489&text=hi'}
                className="special-underline no-underline hover:text-gray-100 dark:text-gray-100 hover:dark:text-gray-100"
              >
                Whatsapp
                <svg
